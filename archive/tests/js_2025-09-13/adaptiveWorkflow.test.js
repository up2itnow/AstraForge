...
describe('AdaptiveWorkflowRL', () => {
    ...
    describe('State Serialization', () => {
        it('should serialize states consistently', () => {
            ...
            const serialized = rl.serializeState(state);
        ...
        it('should round values consistently for state bucketing', () => {
            ...
            const serialized1 = rl.serializeState(state1);
            const serialized2 = rl.serializeState(state2);
    ...
    describe('Action Management', () => {
        it('should serialize and deserialize actions correctly', () => {
            ...
            const serialized = rl.serializeAction(action);
            const deserialized = rl.deserializeAction(serialized);
    ...
    describe('Action Selection', () => {
        ...
        it('should explore with epsilon probability', () => {
            rl.explorationRate = 1.0; // Always explore
            // Add Q-values
            rl.updateQValue(mockState, { type: 'continue', confidence: 1.0 }, 1.0, mockState);
            const actions = [];
            for (let i = 0; i < 10; i++) {
