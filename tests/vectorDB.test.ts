...
describe('VectorDB', () => {
  ...
  let mockHf: jest.Mocked<HfInference>;
  ...
  describe('Fallback Embedding', () => {
    it('should generate deterministic embeddings', async () => {
      const embedding1 = (vectorDB as any).getFallbackEmbedding('test');
      const embedding2 = (vectorDB as any).getFallbackEmbedding('test');
    ...
    it('should generate different embeddings for different text', async () => {
      const embedding1 = (vectorDB as any).getFallbackEmbedding('test1');
      const embedding2 = (vectorDB as any).getFallbackEmbedding('test2');
